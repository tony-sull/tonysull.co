...
import screenshot from '~/assets/uploads/2022-04-08-astro-showcase-screenshot.jpg'
...
<ArticlePhoto
  src={screenshot}
  caption="Screenshot of three showcase sites built with Astro"
  alt="Introducing the new Astro Showcase"
/>
