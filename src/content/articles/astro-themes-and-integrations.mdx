...
featured: '~/assets/uploads/2022-04-06-astro-themes-and-integrations.jpg'
uid: https://astro.build/blog/themes-and-integrations/
author: astro
---

import ArticlePhoto from '~/components/ArticlePhoto.astro'
import themesIntegrations from '~/assets/uploads/2022-04-06-astro-themes-and-integrations.jpg'
import themes from '~/assets/uploads/2022-04-06-astro-themes.png'
import partytown from '~/assets/uploads/2022-04-06-astro-partytown.png'
...
<ArticlePhoto
  src={themesIntegrations}
  caption="Screenshot of Astro's themes and integrations catalogs"
  alt="Introducing the new Astro Themes & Integrations Catalogs"
/>
...
<ArticlePhoto
  src={themes}
  caption="Screenshot of Astro's themes catalog"
  alt="Introducing the new Astro Themes Catalog"
/>
...
<ArticlePhoto
  src={partytown}
  caption="Command prompt previewing the new 'astro add partytown' CLI tool"
  alt="Add Partytown to your Astro site with a single command"
/>
