...
featured: '../../assets/uploads/2023-01-22-introducing-astro-fathom.jpg'
---

import ArticlePhoto from '../../components/ArticlePhoto.astro'
import devtools from '../../assets/uploads/2023-01-22-astro-build-devtools.png'
...
<ArticlePhoto
	src={devtools}
	caption="Browser developer tools showing Fathom analytics running on https://astro.build"
	alt="Fathom Analytics loading their main script.js bundle"
/>
